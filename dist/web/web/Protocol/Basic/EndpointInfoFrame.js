import { BinaryMessageType, CRYO_PROTOCOL_FEATURES, CRYO_PROTOCOL_VERSION, DeserializationError } from "../../../protocol_base.js";
...
export class EndpointInfoFrame {
    ...
    static Serialize(sid, ack) {
        const msg_buf = CryoBuffer.alloc(8 + 1 + 4 + 4 + 8);
