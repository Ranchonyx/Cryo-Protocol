import { BinaryMessageType, DeserializationError, CRYO_MAX_PAYLOAD, SerializationError } from "../../../agnostic/protocol_agnostic.js";
...
export class ErrorFrame {
    ...
    static Serialize(sid, ack, payload) {
        ...
        const msg_buf = Buffer.alloc(16 + 4 + 1 + err_len);
